#!/usr/bin/env python3
"""
Unilever 2023 Sentiment Scorer
Reads unilever_2023_stock_headlines_google_rss.csv from disk,
runs FinBERT and VADER on the summary column, and saves
unilever_2023_sentiment_scored.csv with added columns:
  - finbert_label    (positive / negative / neutral)
  - finbert_score    (confidence 0-1)
  - finbert_numeric  (+1 / 0 / -1)
...
Install requirements (run once):
    pip install pandas transformers torch vaderSentiment tqdm
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
INPUT_CSV  = "unilever_2023_stock_headlines_google_rss.csv"
OUTPUT_CSV = "unilever_2023_sentiment_scored.csv"
