#!/usr/bin/env python3
"""
HSBC 2021 Random Forest — Market Only vs Market + Sentiment
===================================================================
...
Output files:
    hsbc2021_rf_model_A_market_only_performance.csv
    hsbc2021_rf_model_B_market_sentiment_performance.csv
    hsbc2021_rf_model_A_predictions.csv
    hsbc2021_rf_model_B_predictions.csv
    hsbc2021_rf_feature_importance_market_only.csv
    hsbc2021_rf_feature_importance_market_sentiment.csv
    hsbc2021_rf_comparison.csv
"""
...
res_A, preds_A, imp_A = run_rf(
    ...
    "HSBC 2021 — Random Forest (Market Only)"
)
...
res_B, preds_B, imp_B = run_rf(
    ...
    "HSBC 2021 — Random Forest (Market + Sentiment)"
)
...
delta = (
    compare_df.loc["HSBC 2021 — Random Forest (Market + Sentiment)"]
    - compare_df.loc["HSBC 2021 — Random Forest (Market Only)"]
).round(4)
...
# ─────────────────────────────────────────────────────────────────
pd.DataFrame([res_A]).to_csv("hsbc2021_rf_model_A_market_only_performance.csv",      index=False)
pd.DataFrame([res_B]).to_csv("hsbc2021_rf_model_B_market_sentiment_performance.csv", index=False)
preds_A.to_csv("hsbc2021_rf_model_A_predictions.csv",              index=False)
preds_B.to_csv("hsbc2021_rf_model_B_predictions.csv",              index=False)
imp_A.to_csv("hsbc2021_rf_feature_importance_market_only.csv",     index=False)
imp_B.to_csv("hsbc2021_rf_feature_importance_market_sentiment.csv", index=False)
compare_df.reset_index().to_csv("hsbc2021_rf_comparison.csv",      index=False)

print("\nFiles saved:")
print("  hsbc2021_rf_model_A_market_only_performance.csv")
print("  hsbc2021_rf_model_B_market_sentiment_performance.csv")
print("  hsbc2021_rf_model_A_predictions.csv")
print("  hsbc2021_rf_model_B_predictions.csv")
print("  hsbc2021_rf_feature_importance_market_only.csv")
print("  hsbc2021_rf_feature_importance_market_sentiment.csv")
print("  hsbc2021_rf_comparison.csv")
