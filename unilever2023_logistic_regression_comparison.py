#!/usr/bin/env python3
"""
Unilever 2023 Logistic Regression — Market Only vs Market + Sentiment
=========================================================================
...
Output files:
    unilever2023_model_A_market_only_performance.csv
    unilever2023_model_B_market_sentiment_performance.csv
    unilever2023_model_A_predictions.csv
    unilever2023_model_B_predictions.csv
    unilever2023_coefficients_market_only.csv
    unilever2023_coefficients_market_sentiment.csv
    unilever2023_comparison.csv
"""
...
# ─────────────────────────────────────────────────────────────────
# STEP 1 — Load & filter market data to Unilever 2023
# ─────────────────────────────────────────────────────────────────
print("=" * 65)
...
res_A, preds_A, coef_A = run_logistic(
    ...
    "Unilever 2023 — Logistic Regression (Market Only)"
)
...
res_B, preds_B, coef_B = run_logistic(
    ...
    "Unilever 2023 — Logistic Regression (Market + Sentiment)"
)
...
delta = (
    compare_df.loc["Unilever 2023 — Logistic Regression (Market + Sentiment)"]
    - compare_df.loc["Unilever 2023 — Logistic Regression (Market Only)"]
).round(4)
...
# ─────────────────────────────────────────────────────────────────
pd.DataFrame([res_A]).to_csv("unilever2023_model_A_market_only_performance.csv",      index=False)
pd.DataFrame([res_B]).to_csv("unilever2023_model_B_market_sentiment_performance.csv", index=False)
preds_A.to_csv("unilever2023_model_A_predictions.csv",          index=False)
preds_B.to_csv("unilever2023_model_B_predictions.csv",          index=False)
coef_A.to_csv("unilever2023_coefficients_market_only.csv",      index=False)
coef_B.to_csv("unilever2023_coefficients_market_sentiment.csv", index=False)
compare_df.reset_index().to_csv("unilever2023_comparison.csv",  index=False)

print("\nFiles saved:")
print("  unilever2023_model_A_market_only_performance.csv")
print("  unilever2023_model_B_market_sentiment_performance.csv")
print("  unilever2023_model_A_predictions.csv")
print("  unilever2023_model_B_predictions.csv")
print("  unilever2023_coefficients_market_only.csv")
print("  unilever2023_coefficients_market_sentiment.csv")
print("  unilever2023_comparison.csv")
