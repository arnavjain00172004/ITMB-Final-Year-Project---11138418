#!/usr/bin/env python3
"""
BP 2025 Random Forest — Market Only vs Market + Sentiment
===================================================================
...
Output files:
    bp2025_rf_model_A_market_only_performance.csv
    bp2025_rf_model_B_market_sentiment_performance.csv
    bp2025_rf_model_A_predictions.csv
    bp2025_rf_model_B_predictions.csv
    bp2025_rf_feature_importance_market_only.csv
    bp2025_rf_feature_importance_market_sentiment.csv
    bp2025_rf_comparison.csv
"""
...
res_A, preds_A, imp_A = run_rf(
    ...
    "BP 2025 — Random Forest (Market Only)"
)
...
res_B, preds_B, imp_B = run_rf(
    ...
    "BP 2025 — Random Forest (Market + Sentiment)"
)
...
delta = (
    compare_df.loc["BP 2025 — Random Forest (Market + Sentiment)"]
    - compare_df.loc["BP 2025 — Random Forest (Market Only)"]
).round(4)
...
# ─────────────────────────────────────────────────────────────────
pd.DataFrame([res_A]).to_csv("bp2025_rf_model_A_market_only_performance.csv",      index=False)
pd.DataFrame([res_B]).to_csv("bp2025_rf_model_B_market_sentiment_performance.csv", index=False)
preds_A.to_csv("bp2025_rf_model_A_predictions.csv",              index=False)
preds_B.to_csv("bp2025_rf_model_B_predictions.csv",              index=False)
imp_A.to_csv("bp2025_rf_feature_importance_market_only.csv",     index=False)
imp_B.to_csv("bp2025_rf_feature_importance_market_sentiment.csv", index=False)
compare_df.reset_index().to_csv("bp2025_rf_comparison.csv",      index=False)

print("\nFiles saved:")
print("  bp2025_rf_model_A_market_only_performance.csv")
print("  bp2025_rf_model_B_market_sentiment_performance.csv")
print("  bp2025_rf_model_A_predictions.csv")
print("  bp2025_rf_model_B_predictions.csv")
print("  bp2025_rf_feature_importance_market_only.csv")
print("  bp2025_rf_feature_importance_market_sentiment.csv")
print("  bp2025_rf_comparison.csv")
